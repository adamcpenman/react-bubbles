...
ANSWER: Tokens are encrypted Data given from the server for access to private routes and service. To confirm authentication, a token is sent to the serve, and if confirmed, the server responds with private data
- [x] What steps can you take in your web apps to keep your data secure?
using tokens to restrict access to private routes. This helps keep data more secure rather then older mathods like cookes. 
- [x] Describe how web servers work.
Can be described with the physcial computer that stores websites code and the actual program that runs on with computer. Computer connected to the internet input the URL of a website and the server responds with the Data. 
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
CRUD = "Create, Read, Update, Delete"
HTTP Requests = Create = POST, Read = GET, Update = " PUT, Delete = DELETE
